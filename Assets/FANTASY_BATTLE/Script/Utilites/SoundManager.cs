...
public class SoundManager : MonoBehaviour
{
    ...
    private List<SMSound> _sounds = new List<SMSound>();
    [SerializeField]
    private struct PreloadedClip
    {
        public AudioClip clip;
        public int level;
    }

    private Dictionary<string, PreloadedClip> _preloadedClips = new Dictionary<string, PreloadedClip>(16);
